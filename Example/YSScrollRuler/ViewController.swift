...
class ViewController: UIViewController {
    ...
    lazy var rulerView: YSScrollRulerView = { [unowned self] in
        ...
        let unitStr = "¥"
        var rulerView = YSScrollRulerView.init(
    ...
    lazy var rulerView_layout: YSScrollRulerView = { [unowned self] in
        let unitStr = "¥"
        let rulerView = YSScrollRulerView.init(
                frame: .zero,
                config: .init(
                        minValue: 0,
                        maxValue: 1000,
...
extension ViewController: YSScrollRulerViewDelegate {
    func scrollRulerView(rulerView: YSScrollRuler.YSScrollRulerView, valueDidiChanged value: CGFloat) {
//        print(value)
    }
}
